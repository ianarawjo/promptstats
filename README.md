...
Relying purely on bar charts and averages can very, very easily lead to erroneous conclusions—B might actually be more robust than A, or B performs well on an important subset of data, or there's not enough to data to conclude one way or the other. 
...
### Is one prompt is "better" than others? Quantify uncertainty
...
- **Which model is most robust to prompt variation?** 
- **Does Model A actually beat Model B, or only under a specific phrasing?** 
- **How many prompt variants do I need to trust a comparison?** 
